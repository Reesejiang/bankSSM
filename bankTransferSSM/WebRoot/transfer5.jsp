                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
			                            ...
			                            <input type="hidden" name="transferType" value="5"> <!-- 行内汇款 -->
			                            <input type="hidden" name="transferName" value="多币种汇款"> <!-- 存款 -->
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>汇率：</label>
                                            <input type="text" class="form-control" readonly="readonly" name="exchangeRate" value="0.023">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
